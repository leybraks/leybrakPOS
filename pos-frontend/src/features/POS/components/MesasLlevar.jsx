...
export default function MesasLlevar({
  ...
  return (
    <div className="flex-1 flex flex-col animate-fadeIn">
      ...
      {/* Botón principal: Plano, sin sombras, elegante */}
      <button 
        ...
        {ordenesLlevar.map(orden => {
          ...
          return (
            <div key={orden.id} className={`p-4 rounded-2xl flex justify-between items-center relative overflow-hidden transition-all border ${isDark ? 'bg-[#141414] border-[#222] hover:border-[#333]' : 'bg-white border-gray-200 hover:border-gray-300'}`}>
              ...
              <div className={`absolute left-0 top-0 bottom-0 w-1 ${estaPagado ? 'bg-blue-500/80' : 'bg-red-500/80'}`}></div>
              ...
              <div className="flex-1 pl-3">
                <div className="flex flex-wrap items-center gap-2 mb-1.5">
                  ...
                  {/* Badges de Estado (Estilo ERP: Fondo semi-transparente y borde) */}
